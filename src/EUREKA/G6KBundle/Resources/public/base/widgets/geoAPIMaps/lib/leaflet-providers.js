(function (root, factory) {
	...
	L.TileLayer.Provider.providers = {
		...
		GoogleStreets : { // DO NOT USE : Google Terms of Use forbid any means of tile access other than through the Google Maps API.
			url: 'http://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}',
			options: {
				attribution: '<a href="https://www.google.com/intl/fr_fr/help/terms_maps.html">&copy; 2017 Google</a>',
				maxZoom: 20,
