...
var datePickerController = (function datePickerController() {
        ...
        this.onclick = function(e) {
            ...
            while(el.parentNode) {
                ...
                if(el.tagName && el.tagName.toLowerCase() == "td") {
                    ...
                    o.stopTimer();
                    break;
                } else if(el.className && el.className.search(/date-picker-day-header/) != -1) { // JA : 12/30/2014 added test el.className
    ...
    var addDatePicker = function(options) {
        ...
        for(elemID in options.formElements) {
			...
			// la ligne du dessous a été car bug chrome, ie et opéra (JA : 31/10/2014)
