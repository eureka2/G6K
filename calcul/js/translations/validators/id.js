(function (Translator) {
    ...
    Translator.add("fos_user.username.already_used", "Nama pengguna telah digunakan", "validators", "id");
    Translator.add("fos_user.username.blank", "Masukkan nama pengguna", "validators", "id");
    Translator.add("fos_user.username.short", "[-Inf,Inf]Nama pengguna terlalu pendek", "validators", "id");
    Translator.add("fos_user.username.long", "[-Inf,Inf]Nama pengguna terlalu panjang", "validators", "id");
    Translator.add("fos_user.email.already_used", "Email telah digunakan", "validators", "id");
    Translator.add("fos_user.email.blank", "Masukkan alamat email anda", "validators", "id");
    Translator.add("fos_user.email.short", "[-Inf,Inf]Alamat email terlalu pendek", "validators", "id");
    Translator.add("fos_user.email.long", "[-Inf,Inf]Alamat email terlalu panjang", "validators", "id");
    Translator.add("fos_user.email.invalid", "Alamat email salah", "validators", "id");
    Translator.add("fos_user.password.blank", "Masukkan password yang ingin digunakan", "validators", "id");
    Translator.add("fos_user.password.short", "[-Inf,Inf]Password terlalu pendek", "validators", "id");
    Translator.add("fos_user.password.mismatch", "Password yang anda masukkan tidak sama", "validators", "id");
    Translator.add("fos_user.new_password.blank", "Masukkan password baru anda", "validators", "id");
    Translator.add("fos_user.new_password.short", "[-Inf,Inf]Password baru anda terlalu pendek", "validators", "id");
    Translator.add("fos_user.current_password.invalid", "Password yang anda masukkan salah", "validators", "id");
    Translator.add("fos_user.group.blank", "Masukkan nama", "validators", "id");
    Translator.add("fos_user.group.short", "[-Inf,Inf]Nama terlalu pendek", "validators", "id");
    Translator.add("fos_user.group.long", "[-Inf,Inf]Nama terlalu panjang", "validators", "id");
})(Translator);
