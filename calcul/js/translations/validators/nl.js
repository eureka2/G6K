(function (Translator) {
    ...
    Translator.add("This value should be the user current password.", "Deze waarde moet het huidige wachtwoord van de gebruiker zijn.", "validators", "nl");
    ...
    Translator.add("fos_user.username.already_used", "De gebruikersnaam is al in gebruik", "validators", "nl");
    Translator.add("fos_user.username.blank", "Voer een gebruikersnaam in", "validators", "nl");
    Translator.add("fos_user.username.short", "[-Inf,Inf]De gebruikersnaam is te kort", "validators", "nl");
    Translator.add("fos_user.username.long", "[-Inf,Inf]De gebruikersnaam is te lang", "validators", "nl");
    Translator.add("fos_user.email.already_used", "Het e-mailadres is al in gebruik", "validators", "nl");
    Translator.add("fos_user.email.blank", "Voer een e-mailadres in", "validators", "nl");
    Translator.add("fos_user.email.short", "[-Inf,Inf]Het e-mailadres is te kort", "validators", "nl");
    Translator.add("fos_user.email.long", "[-Inf,Inf]Het e-mailadres is te lang", "validators", "nl");
    Translator.add("fos_user.email.invalid", "Het e-mailadres is ongeldig", "validators", "nl");
    Translator.add("fos_user.password.blank", "Voer een wachtwoord in", "validators", "nl");
    Translator.add("fos_user.password.short", "[-Inf,Inf]Het wachtwoord is te kort", "validators", "nl");
    Translator.add("fos_user.password.mismatch", "Het ingevoerde wachtwoord komt niet overeen", "validators", "nl");
    Translator.add("fos_user.new_password.blank", "Voer een nieuw wachtwoord in", "validators", "nl");
    Translator.add("fos_user.new_password.short", "[-Inf,Inf]Het nieuwe wachtwoord is te kort", "validators", "nl");
    Translator.add("fos_user.current_password.invalid", "Het ingevulde wachtwoord is ongeldig", "validators", "nl");
    Translator.add("fos_user.group.blank", "Voer een naam in", "validators", "nl");
    Translator.add("fos_user.group.short", "[-Inf,Inf]De naam is te kort", "validators", "nl");
    Translator.add("fos_user.group.long", "[-Inf,Inf]De naam is te lang", "validators", "nl");
})(Translator);
