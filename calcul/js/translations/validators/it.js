(function (Translator) {
    ...
    Translator.add("This value should be the user current password.", "Questo valore dovrebbe essere la password attuale dell'utente.", "validators", "it");
    ...
    Translator.add("fos_user.username.already_used", "Username gi\u00e0 in uso", "validators", "it");
    Translator.add("fos_user.username.blank", "Si prega di inserire uno username", "validators", "it");
    Translator.add("fos_user.username.short", "[-Inf,Inf]Username troppo breve", "validators", "it");
    Translator.add("fos_user.username.long", "[-Inf,Inf]Username troppo lungo", "validators", "it");
    Translator.add("fos_user.email.already_used", "Email gi\u00e0 in uso", "validators", "it");
    Translator.add("fos_user.email.blank", "Si prega di inserire una email", "validators", "it");
    Translator.add("fos_user.email.short", "[-Inf,Inf]Email troppo breve", "validators", "it");
    Translator.add("fos_user.email.long", "[-Inf,Inf]Email troppo lunga", "validators", "it");
    Translator.add("fos_user.email.invalid", "Email non valida", "validators", "it");
    Translator.add("fos_user.password.blank", "Si prega di inserire una password", "validators", "it");
    Translator.add("fos_user.password.short", "[-Inf,Inf]Password troppo breve", "validators", "it");
    Translator.add("fos_user.password.mismatch", "Le due password non coincidono", "validators", "it");
    Translator.add("fos_user.new_password.blank", "Si prega di inserire nuovamente la password", "validators", "it");
    Translator.add("fos_user.new_password.short", "[-Inf,Inf]Nuova password troppo breve", "validators", "it");
    Translator.add("fos_user.current_password.invalid", "Password non valida", "validators", "it");
    Translator.add("fos_user.group.blank", "Si prega di inserire un nome", "validators", "it");
    Translator.add("fos_user.group.short", "[-Inf,Inf]Nome troppo breve", "validators", "it");
    Translator.add("fos_user.group.long", "[-Inf,Inf]Nome troppo lungo", "validators", "it");
})(Translator);
