(function (Translator) {
    ...
    Translator.add("fos_user.username.already_used", "Brugernavnet er optaget", "validators", "da");
    Translator.add("fos_user.username.blank", "Indtast venligst et brugernavn", "validators", "da");
    Translator.add("fos_user.username.short", "Brugernavnet er for kort", "validators", "da");
    Translator.add("fos_user.username.long", "Brugernavnet er for langt", "validators", "da");
    Translator.add("fos_user.email.already_used", "E-mail adressen er allerede brugt", "validators", "da");
    Translator.add("fos_user.email.blank", "Indtast venligst en e-mail adresse", "validators", "da");
    Translator.add("fos_user.email.short", "E-mail adressen er for kort", "validators", "da");
    Translator.add("fos_user.email.long", "E-mail adressen er for lang", "validators", "da");
    Translator.add("fos_user.email.invalid", "E-mail adressen er ikke gyldig", "validators", "da");
    Translator.add("fos_user.password.blank", "Indtast venligst et kodeord", "validators", "da");
    Translator.add("fos_user.password.short", "Kodeordet er for kort", "validators", "da");
    Translator.add("fos_user.new_password.blank", "Indtast venligst et nyt kodeord", "validators", "da");
    Translator.add("fos_user.new_password.short", "Det nye kodeord er for kort", "validators", "da");
    Translator.add("fos_user.current_password.invalid", "Det indtastede kodeord er forkert", "validators", "da");
    Translator.add("fos_user.group.blank", "Indtast venligst et navn", "validators", "da");
    Translator.add("fos_user.group.short", "Navnet er for kort", "validators", "da");
    Translator.add("fos_user.group.long", "Navnet er for langt", "validators", "da");
})(Translator);
