(function (Translator) {
    ...
    Translator.add("fos_user.username.already_used", "Uporabni\u0161ko ime \u017ee obstaja", "validators", "sl");
    Translator.add("fos_user.username.blank", "Prosimo, vnesite uporabni\u0161ko ime", "validators", "sl");
    Translator.add("fos_user.username.short", "[-Inf,Inf]Uporabni\u0161ko ime je prekratko", "validators", "sl");
    Translator.add("fos_user.username.long", "[-Inf,Inf]Uporabni\u0161ko ime je predolgo", "validators", "sl");
    Translator.add("fos_user.email.already_used", "Email \u017ee obstaja", "validators", "sl");
    Translator.add("fos_user.email.blank", "Prosimo, vnesite email", "validators", "sl");
    Translator.add("fos_user.email.short", "[-Inf,Inf]Email je prekratek", "validators", "sl");
    Translator.add("fos_user.email.long", "[-Inf,Inf]Email je predolg", "validators", "sl");
    Translator.add("fos_user.email.invalid", "Email je napa\u010den", "validators", "sl");
    Translator.add("fos_user.password.blank", "Prosimo, vnesite geslo", "validators", "sl");
    Translator.add("fos_user.password.short", "[-Inf,Inf]Geslo je prekratko", "validators", "sl");
    Translator.add("fos_user.password.mismatch", "Vpisani gesli se ne ujemata", "validators", "sl");
    Translator.add("fos_user.new_password.blank", "Prosimo, vnesite novo geslo", "validators", "sl");
    Translator.add("fos_user.new_password.short", "[-Inf,Inf]Novo geslo je prekratko", "validators", "sl");
    Translator.add("fos_user.current_password.invalid", "Geslo je napa\u010dno", "validators", "sl");
    Translator.add("fos_user.group.blank", "Prosimo, vnesite ime", "validators", "sl");
    Translator.add("fos_user.group.short", "[-Inf,Inf]Ime je prekratko", "validators", "sl");
    Translator.add("fos_user.group.long", "[-Inf,Inf]Ime je predolgo", "validators", "sl");
})(Translator);
