(function (Translator) {
    ...
    Translator.add("fos_user.username.already_used", "Dieser Benutzername wird bereits verwendet", "validators", "de");
    Translator.add("fos_user.username.blank", "Bitte geben Sie einen Benutzernamen an", "validators", "de");
    Translator.add("fos_user.username.short", "[-Inf,Inf]Dieser Benutzername ist zu kurz", "validators", "de");
    Translator.add("fos_user.username.long", "[-Inf,Inf]Dieser Benutzername ist zu lang", "validators", "de");
    Translator.add("fos_user.email.already_used", "Diese E-Mail-Adresse wird bereits verwendet", "validators", "de");
    Translator.add("fos_user.email.blank", "Bitte geben Sie eine E-Mail-Adresse an", "validators", "de");
    Translator.add("fos_user.email.short", "[-Inf,Inf]Diese E-Mail-Adresse ist zu kurz", "validators", "de");
    Translator.add("fos_user.email.long", "[-Inf,Inf]Diese E-Mail-Adresse ist zu lang", "validators", "de");
    Translator.add("fos_user.email.invalid", "Diese E-Mail-Adresse ist ung\u00fcltig", "validators", "de");
    Translator.add("fos_user.password.blank", "Bitte geben Sie ein Passwort an", "validators", "de");
    Translator.add("fos_user.password.short", "[-Inf,Inf]Das Passwort ist zu kurz", "validators", "de");
    Translator.add("fos_user.password.mismatch", "Die Passw\u00f6rter stimmen nicht \u00fcberein", "validators", "de");
    Translator.add("fos_user.new_password.blank", "Bitte geben Sie ein neues Passwort an", "validators", "de");
    Translator.add("fos_user.new_password.short", "[-Inf,Inf]Das neue Passwort ist zu kurz", "validators", "de");
    Translator.add("fos_user.current_password.invalid", "Das angegebene Passwort ist ung\u00fcltig", "validators", "de");
    Translator.add("fos_user.group.blank", "Bitte geben Sie einen Namen an", "validators", "de");
    Translator.add("fos_user.group.short", "[-Inf,Inf]Dieser Name ist zu kurz", "validators", "de");
    Translator.add("fos_user.group.long", "[-Inf,Inf]Dieser Name ist zu lang", "validators", "de");
})(Translator);
