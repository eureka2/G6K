(function (Translator) {
    ...
    Translator.add("fos_user.username.already_used", "Korisni\u010dko ime ve\u0107 postoji", "validators", "sr_Latn");
    Translator.add("fos_user.username.blank", "Molimo, unesite korisni\u010dko ime", "validators", "sr_Latn");
    Translator.add("fos_user.username.short", "[-Inf,Inf]Korisni\u010dko ime je prekratko", "validators", "sr_Latn");
    Translator.add("fos_user.username.long", "[-Inf,Inf]Korisni\u010dko ime je predugo", "validators", "sr_Latn");
    Translator.add("fos_user.email.already_used", "Adresa e-po\u0161te ve\u0107 postoji", "validators", "sr_Latn");
    Translator.add("fos_user.email.blank", "Molimo, unesite adresu e-po\u0161te", "validators", "sr_Latn");
    Translator.add("fos_user.email.short", "[-Inf,Inf]Adresa e-po\u0161te je prekratka", "validators", "sr_Latn");
    Translator.add("fos_user.email.long", "[-Inf,Inf]Adresa e-po\u0161te je preduga", "validators", "sr_Latn");
    Translator.add("fos_user.email.invalid", "Adresa e-po\u0161te nije validna", "validators", "sr_Latn");
    Translator.add("fos_user.password.blank", "Molimo, unesite lozinku", "validators", "sr_Latn");
    Translator.add("fos_user.password.short", "[-Inf,Inf]Lozinka je prekratka", "validators", "sr_Latn");
    Translator.add("fos_user.new_password.blank", "Molimo, unesite novu lozinku", "validators", "sr_Latn");
    Translator.add("fos_user.new_password.short", "[-Inf,Inf]Nova lozinka je prekratka", "validators", "sr_Latn");
    Translator.add("fos_user.current_password.invalid", "Lozinka nije validna", "validators", "sr_Latn");
    Translator.add("fos_user.group.blank", "Molimo unesite naziv", "validators", "sr_Latn");
    Translator.add("fos_user.group.short", "[-Inf,Inf]Naziv je prekratak", "validators", "sr_Latn");
    Translator.add("fos_user.group.long", "[-Inf,Inf]Naziv je predug", "validators", "sr_Latn");
})(Translator);
