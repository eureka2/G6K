(function (Translator) {
    ...
    Translator.add("fos_user.username.already_used", "Erabiltzaile izena hori erabiltzen da dagoeneko", "validators", "eu");
    Translator.add("fos_user.username.blank", "Sartu erabiltzaile izena mesedez", "validators", "eu");
    Translator.add("fos_user.username.short", "[-Inf,Inf]Erabiltzaile izena motzegia da", "validators", "eu");
    Translator.add("fos_user.username.long", "[-Inf,Inf]Erabiltzaile izena luzeegia da", "validators", "eu");
    Translator.add("fos_user.email.already_used", "E-posta helbide hori erabiltzen da dagoeneko", "validators", "eu");
    Translator.add("fos_user.email.blank", "Sarty E-posta helbidea mesedez", "validators", "eu");
    Translator.add("fos_user.email.short", "[-Inf,Inf]E-posta helbidea motzegia da", "validators", "eu");
    Translator.add("fos_user.email.long", "[-Inf,Inf]E-posta helbidea luzeegia da", "validators", "eu");
    Translator.add("fos_user.email.invalid", "E-posta helbidea ez da zuzena", "validators", "eu");
    Translator.add("fos_user.password.blank", "Sartu pasahitza mesedez", "validators", "eu");
    Translator.add("fos_user.password.short", "[-Inf,Inf]Pasahitza motzegia da", "validators", "eu");
    Translator.add("fos_user.password.mismatch", "Bi pasahitzek ez dute bat egiten", "validators", "eu");
    Translator.add("fos_user.new_password.blank", "Sartu pasahitz berria mesedez", "validators", "eu");
    Translator.add("fos_user.new_password.short", "[-Inf,Inf]Pasahitz berria motzegia da", "validators", "eu");
    Translator.add("fos_user.current_password.invalid", "Sartutako pasahitza ez da baliagarria", "validators", "eu");
    Translator.add("fos_user.group.blank", "Sartu izena mesedez", "validators", "eu");
    Translator.add("fos_user.group.short", "[-Inf,Inf]Izena motzegia da", "validators", "eu");
    Translator.add("fos_user.group.long", "[-Inf,Inf]Izena luzeegia da", "validators", "eu");
})(Translator);
