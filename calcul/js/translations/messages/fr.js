(function (Translator) {
    ...
    Translator.add("Associative array", "Tableau associatif", "messages", "fr");
    ...
    Translator.add("Date format of the parameter with characters : d, j, D, l or z (day) - F, M, m or n (month) - Y, y (year)", "Format de date du param\u00e8tre form\u00e9 avec les caract\u00e8res : d, j, D, l ou z (jour) - F, M, m ou n (mois) - Y, y (an)", "messages", "fr");
    ...
    Translator.add("Incorrect action button name", "Nom du bouton d'action incorrect", "messages", "fr");
    Translator.add("Incorrect blockinfo name", "Nom du bloc d'infos incorrect", "messages", "fr");
    Translator.add("Incorrect chapter name", "Nom du chap\u00eetre incorrect", "messages", "fr");
    Translator.add("Incorrect column name", "Le nom de la colonne est incorrect", "messages", "fr");
    Translator.add("Incorrect database name", "Le nom de la base de donn\u00e9es est incorrect", "messages", "fr");
    Translator.add("Incorrect data name", "Le nom de la donn\u00e9e est incorrect", "messages", "fr");
    Translator.add("Incorrect data value", "La valeur de la donn\u00e9e est erron\u00e9e", "messages", "fr");
    Translator.add("Incorrect panel name", "Nom du panneau incorrect", "messages", "fr");
    Translator.add("Incorrect pop-in link", "Lien d'activation du pop-in incorrect", "messages", "fr");
    Translator.add("Incorrect profile name", "Nom du profil incorrect", "messages", "fr");
    Translator.add("Incorrect section name", "Nom de section incorrect", "messages", "fr");
    Translator.add("Incorrect step name", "Nom d'\u00e9tape incorrect", "messages", "fr");
    ...
    Translator.add("PATH", "Chemin d'URL", "messages", "fr");
