...
t.add("You must select at least {{ limit }} choice.|You must select at least {{ limit }} choices.", "Morate odabrati bar {{ limit }} mogu\u0107nost.|Morate odabrati bar {{ limit }} mogu\u0107nosti.", "validators", "sr_Latn");
t.add("You must select at most {{ limit }} choice.|You must select at most {{ limit }} choices.", "Morate odabrati najvi\u0161e {{ limit }} mogu\u0107nost.|Morate odabrati najvi\u0161e {{ limit }} mogu\u0107nosti.", "validators", "sr_Latn");
...
t.add("This value is too long. It should have {{ limit }} character or less.|This value is too long. It should have {{ limit }} characters or less.", "Vrednost je preduga\u010dka. Trebalo bi da ima {{ limit }} karakter ili manje.|Vrednost je preduga\u010dka. Trebalo bi da ima {{ limit }} karaktera ili manje.", "validators", "sr_Latn");
t.add("This value should be {{ limit }} or more.", "Vrednost bi trebalo da bude {{ limit }} ili vi\u0161e.", "validators", "sr_Latn");
t.add("This value is too short. It should have {{ limit }} character or more.|This value is too short. It should have {{ limit }} characters or more.", "Vrednost je prekratka. Trebalo bi da ima {{ limit }} karakter ili vi\u0161e.|Vrednost je prekratka. Trebalo bi da ima {{ limit }} karaktera ili vi\u0161e.", "validators", "sr_Latn");
...
t.add("This value should have exactly {{ limit }} character.|This value should have exactly {{ limit }} characters.", "Vrednost bi trebalo da ima ta\u010dno {{ limit }} karakter.|Vrednost bi trebalo da ima ta\u010dno {{ limit }} karaktera.", "validators", "sr_Latn");
...
t.add("This collection should contain {{ limit }} element or more.|This collection should contain {{ limit }} elements or more.", "Ova kolekcija bi trebalo da sadr\u017ei {{ limit }} ili vi\u0161e elemenata.|Ova kolekcija bi trebalo da sadr\u017ei {{ limit }} ili vi\u0161e elemenata.", "validators", "sr_Latn");
t.add("This collection should contain {{ limit }} element or less.|This collection should contain {{ limit }} elements or less.", "Ova kolekcija bi trebalo da sadr\u017ei {{ limit }} ili manje elemenata.|Ova kolekcija bi trebalo da sadr\u017ei {{ limit }} ili manje elemenata.", "validators", "sr_Latn");
t.add("This collection should contain exactly {{ limit }} element.|This collection should contain exactly {{ limit }} elements.", "Ova kolekcija bi trebalo da sadr\u017ei ta\u010dno {{ limit }} element.|Ova kolekcija bi trebalo da sadr\u017ei ta\u010dno {{ limit }} elemenata.", "validators", "sr_Latn");
...
t.add("fos_user.username.already_used", "Korisni\u010dko ime ve\u0107 postoji.", "validators", "sr_Latn");
t.add("fos_user.username.blank", "Molimo, unesite korisni\u010dko ime.", "validators", "sr_Latn");
t.add("fos_user.username.short", "Korisni\u010dko ime je prekratko.", "validators", "sr_Latn");
t.add("fos_user.username.long", "Korisni\u010dko ime je predugo.", "validators", "sr_Latn");
t.add("fos_user.email.already_used", "Adresa e-po\u0161te ve\u0107 postoji.", "validators", "sr_Latn");
t.add("fos_user.email.blank", "Molimo, unesite adresu e-po\u0161te.", "validators", "sr_Latn");
t.add("fos_user.email.short", "Adresa e-po\u0161te je prekratka.", "validators", "sr_Latn");
t.add("fos_user.email.long", "Adresa e-po\u0161te je preduga.", "validators", "sr_Latn");
t.add("fos_user.email.invalid", "Adresa e-po\u0161te nije validna.", "validators", "sr_Latn");
t.add("fos_user.password.blank", "Molimo, unesite lozinku.", "validators", "sr_Latn");
t.add("fos_user.password.short", "Lozinka je prekratka.", "validators", "sr_Latn");
t.add("fos_user.new_password.blank", "Molimo, unesite novu lozinku.", "validators", "sr_Latn");
t.add("fos_user.new_password.short", "Nova lozinka je prekratka.", "validators", "sr_Latn");
t.add("fos_user.current_password.invalid", "Lozinka nije validna.", "validators", "sr_Latn");
t.add("fos_user.group.blank", "Molimo unesite naziv.", "validators", "sr_Latn");
t.add("fos_user.group.short", "Naziv je prekratak.", "validators", "sr_Latn");
t.add("fos_user.group.long", "Naziv je predug.", "validators", "sr_Latn");
t.add("fos_group.name.already_used", "Ovo ime ve\u0107 postoji.", "validators", "sr_Latn");
})(Translator);
