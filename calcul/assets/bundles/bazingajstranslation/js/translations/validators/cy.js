...
t.add("This is not a valid International Bank Account Number (IBAN).", "Nid yw hwn yn Rhif Cyfrif Banc Rhyngwladol (IBAN) dilys.", "validators", "cy");
...
t.add("This is not a valid Business Identifier Code (BIC).", "Nid yw hwn yn God Adnabod Busnes (BIC) dilys.", "validators", "cy");
t.add("Error", "Gwall", "validators", "cy");
t.add("This is not a valid UUID.", "Nid yw hyn yn UUID dilys.", "validators", "cy");
