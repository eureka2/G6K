        ...
        if (useDocumentSelection) {
            ...
            refreshSelection = function(sel) {
                if (implementsControlRange && implementsDocSelection && sel.docSelection.type == CONTROL) {
                    ...
                    sel._ranges.length = sel.rangeCount = sel.nativeSelection ? sel.nativeSelection.rangeCount : 0; // modified by Eureka 2
                    if (sel.rangeCount) {
...
wysihtml.browser = (function() {
  ...
  return {
    ...
    supportsMutationObserver: function() { // added by Eureka 2
...
wysihtml.dom.query = function(elements, query) {
    ...
    for (var e = 0, len = elements.length; e < len; e++) {
        ...
        if (q) {
            for(var i = q.length; i--; ret.unshift(q[i])) {}; // modified by Eureka 2
        }
    }
    return ret;
};
...
(function(wysihtml) {
  ...
  wysihtml.dom.Sandbox = Base.extend(
    ...
    _onLoadIframe: function(iframe) {
      ...
      this.getDocument = function() { return iframe.contentWindow ? iframe.contentWindow.document : null; }; // modified bye Eureka 2
...
wysihtml.Commands = Base.extend(
  ...
  exec: function(command, value) {
    ...
    this.editor.fire("beforecommand:composer", { command: command, value: value }); // added by Eureka 2
    ...
    this.editor.fire("aftercommand:composer", { command: command, value: value }); // added by Eureka 2
    return result;
  },
...
(function(wysihtml) {
  ...
  wysihtml.views.Composer.prototype.observe = function() {
    ...
    if (browser.supportsMutationObserver()) { // modified by Eureka 2
      var editorObserver = new MutationObserver(function(mutations) {
        mutations.forEach(function(mutation) {
          if (mutation.removedNodes.length > 0 && !dom.contains(document.documentElement, container)) {
            handleDomNodeRemoved.call(that);
          }
        });
      });
      editorObserver.observe(container.parentNode, {childList: true});
    } else if (browser.supportsMutationEvents()) {
    ...
    _getDialog: function(link, command) {
      ...
      if (dialogElement) {
        ...
        dialog.on("change", function() {
          caretBookmark = that.composer.selection.getBookmark();
          that.editor.fire("change:dialog", { command: command, dialogContainer: dialogElement, commandLink: link });
        });
...
(function(factory){
	...
	var toolbar = {
		...
		'hilite':
			`<button style="padding: 4px 6px 4px 6px" type="button" class="btn btn-default" tabindex="-1" aria-haspopup="true" aria-expanded="false">
		...
		'blocks':
			`<button title="Styles" id="wysiwyg-font-style" type="button" tabindex="-1" data-wysihtml-command-group="formatBlock" class="btn btn-default dropdown-toggle" aria-haspopup="true" aria-expanded="false">
		...
		'font-named-sizes':
			`<button title="Font size" id="wysiwyg-font-size" type="button" tabindex="-1" data-wysihtml-command-group="fontSize" class="btn btn-default dropdown-toggle" aria-haspopup="true" aria-expanded="false">
		...
		'font-names':
			`<div class="btn-group">
				<div>
					<button title="Fonts" id="wysiwyg-font-name" type="button" tabindex="-1" data-wysihtml-command-group="fontNameStyle" class="btn btn-default dropdown-toggle" aria-haspopup="true" aria-expanded="false">
	...
	var dialogs = {
		'createLink':
			`<div class="row" data-wysihtml-dialog="createLink" style="display: none;">
				...
				<a class="btn btn-primary btn-sm" tabindex="0" data-wysihtml-dialog-action="save">OK</a>&nbsp;<a class="btn btn-default btn-sm" tabindex="0" data-wysihtml-dialog-action="cancel">Cancel</a>
	...
	var initialize = function(self) {
		...
		$.each(self.options.customDialogs, function(key, dialog) {
			...
			dialog += '<a class="btn btn-primary btn-sm" tabindex="0" data-wysihtml-dialog-action="save">OK</a>&nbsp;<a class="btn btn-default btn-sm" tabindex="0" data-wysihtml-dialog-action="cancel">Cancel</a>';
